...
const clutterItems = ['aqv','cqv','isc','tsc','key','vps','wms','yps',
							 'gpl','gpm','gps','opl','opm','ops'];


export function removeClutter(row: TSVDataRow) {
  for (let i = 1; i <= 10; i++) {
...
export function runRemoveClutterItems(treasureRows: TSVDataRow[]) {
