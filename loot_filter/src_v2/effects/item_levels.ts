...
import { QuestItemIds } from '../models/types';
 ...
 */
function enableShowLevelExcept(data: TSVData, exclusions: string[]): TSVData {
 ...
 */
function enableShowLevelFor(data: TSVData, inclusions: string[]): TSVData {
	data.rows.forEach(row => {
